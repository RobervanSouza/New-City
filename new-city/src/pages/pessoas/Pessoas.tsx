...
import { IPessoas, PessoasService } from "../../shared/services/api/passoas/PessoasService";
      ...
      <LayoutePages
        ...
        barraDeFerramentas={
          <FerramentasDaListagem
            ...
            textoBotaoVovo="Nova"
            textoBusca={busca}
            mudarTextoBusca={texto => setSerchParams({ busca: texto, pagina:'1' }, { replace: true })} // o replace >> e para buscar impede que registra varias rotas, e quando você visita varias paginas e ele volta para o historico
          />
        }>
        <TableContainer
          component={Paper}
            ...
            <TableFooter>
              ...
              <TableRow>
                ...
                colSpan={3} 
                 ...
                 onChange={ (_, newPage) => setSerchParams({busca, pagina: newPage.toString()},{replace: true} ) }// essa função e para navegar na paginas clicar onde quizer ex pg7
                  /> 
                  </TableCell>              
              </TableRow>
              )}
