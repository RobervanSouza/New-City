...
export const useDebounce = (delay= 500, notDelay = true) => { // essa fução e para atrazar a resposta quando  usuario for pesquisar
...
// se for a primeira vez executa aqui direto, se não executa embaixo
    ...
    if (debounceces.current){ // verifia se ja estiver um timeout cadastado então cancela e executa  o outro. POR EXEMPLO DIGITA UMA LETRA E ESPERA 30MS PARA EXECUTAR CASO DIGITE OUTRA LENTRA ENTÃO CANCELA A BUSCA ATE QUE TENHA DIGITADO TUDO  e espera um segundo para mostar
